        ...
        <View style = {styles.container}>
            ...
            <View style = {styles.viewImg}>
                <View style = {styles. viewCima}>
                    <View style = {styles. imgEsq}>
                        ...
                        <View style = {styles.viewImgBloco}>
                            <Link to= {{screen: "PetShop"}}> <Image style = {styles.img} source = {require('../../assets/Icons/PetShop.png')}/> </Link>
                        </View>
                    ...
                    <View style = {styles. imgDir}>
                        ...
                        <View style = {styles.viewImgBloco}>
                            <Link to= {{screen: "Veterinario"}}> <Image style = {styles.img} source = {require('../../assets/Icons/Vet.png')}/> </Link>
                        </View>
                ...
                <View style = {styles. viewBaixo}>
                    <View style = {styles. imgEsq}>
                        <View style = {styles.viewImgBloco}>                                                           
                        <Link to= {{screen: "Conquistas"}}> <Image style = {styles.img} source = {require('../../assets/Icons/Conquistas.png')}/></Link>
                        </View>
                        <Text style = {styles.txt}>Conquistas</Text>
                    </View>  
                    <View style = {styles. imgDir}>
                        <View style = {styles.viewImgBloco}>
                            <Link to= {{screen: ""}}> <Image style = {styles.img} source = {require('../../assets/Icons/Config.png')}/> </Link>
                        </View>
            ...
            <View style = {styles.viewVoltarBtn}>
                <TouchableHighlight {...Voltar}  style = {styles.voltarBtn}>
                    ...
                    <Link to= {{screen: "InicialPage1"}} style = {styles.txtVoltarBtn}>{"<"}</Link>  
                </TouchableHighlight>
            </View>
        </View>
    )
